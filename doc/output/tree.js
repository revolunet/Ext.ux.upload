		...
		Docs.classData ={"id":"apidocs","iconCls":"icon-docs","text":"API Documentation","singleClickExpand":true,"children":[
				...
				,
                {"href":"output/Ext.ux.upload.LogPanel.html","text":"LogPanel","id":"Ext.ux.upload.LogPanel","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
				...
				,
                {"href":"output/Ext.ux.Dialog.html","text":"Dialog","id":"Ext.ux.Dialog","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				,
                {"href":"output/Ext.ux.StatusBar.html","text":"StatusBar","id":"Ext.ux.StatusBar","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
				]}
				,
        ...
        Docs.icons = {
			...
			,
			"Ext.ux.upload.LogPanel":"icon-cmp"
			,
			"Ext.ux.upload.SwfConnector":"icon-cls"
			,
			"Ext.ux.upload.Uploader":"icon-cls"
			,
			"Ext.ux.Dialog":"icon-cmp"
			,
			"Ext.ux.StatusBar":"icon-cmp"
			,
			"Ext.Action":"icon-cls"
			,
